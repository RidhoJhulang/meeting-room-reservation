...
public class UserController {
    ...
    @PostMapping("/create")
    public String createConfirm(HttpServletRequest request, RedirectAttributes redirectAttributes, HttpServletResponse response, Model model) {
        try {
    ...
    public String updateUser(HttpServletRequest request, RedirectAttributes redirectAttributes, Model model, Users users, @PathVariable Long id) {
        try {
